...
namespace VOD.API.Controllers
{
    ...
    public class VideosController : ControllerBase
    {
        ...
        [HttpPut("{id:int}")]
        public async Task<ActionResult> Put(int id, int courseId, int moduleId, VideoDTO model)
        {
            try
            {
                if (model == null)
                ...
                var success = await _db.UpdateAsync<VideoDTO, Video>(model);
                if (success)
                {
                    return NoContent();
                }
        ...
        public async Task<IActionResult> Delete(int id, int courseId, int moduleId)
        {
            try
            {
                var exists = await _db.AnyAsync<Video>(a =>
                ...
                var success = await _db.DeleteAsync<Video>(d =>
